...
angular.module('textAngularSetup', [])
    ...
    .run(['taRegisterTool', '$window', 'taTranslations', 'taSelection', 'taToolFunctions', '$sanitize', 'taOptions', 'dialogService', function (taRegisterTool, $window, taTranslations, taSelection, taToolFunctions, $sanitize, taOptions, dialogService) {
